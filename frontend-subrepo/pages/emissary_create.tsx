                            ...
                            <>
                                ...
                                <Grid item xs={12} sm={12} md={6}>
                                    <div className='lunch-item text-center'>
                                        <img className='lunch-icon-b' src='assets/img/subwallet-logo.png' />
                                        <p className='lunch-text '>Subwallet</p>
                                        <p className='lunch-text-sub text-underline'>Don't have subwallet? Download here</p>
                                        <div className='mt-30'>
                                            {
                                ...
                                <Grid item xs={12} sm={12} md={12}>
                                    ...
                                    }
                                    {
                                        ...
                                        <>
                                                ...
                                                assets.map((as, idx) => {
                                                    return (
                                                        <div key={idx} className='flex-start mt-10'>
                                                            ...
                                                            <RemoveCircleOutlineOutlinedIcon className='font-30 pink-text ml-10 cursor-point' onClick={() => delAsset(idx)} />
                                                        </div>
                                                    )
                                                })
                                            }
                                            <div className='flex-start mt-10'>
                                                ...
                                                <AddCircleOutlineOutlinedIcon className='font-30 pink-text ml-10 cursor-point' onClick={() => plusAsset()} />
                                            </div>
                                        </>
                                    ...
                                    }
                                    {
                                        ...
                                        <div className='flex-start'>
                                            <Button className='pink-btn font-unbound mt-30 p0 mr-10' onClick={() => back()}><ArrowCircleLeftOutlinedIcon className='font-30' /></Button>
                                            <Button className='pink-btn font-unbound mt-30' onClick={() => proceed()}> {step == 4 ? "Create" : "Proceed"}  </Button>
                                        </div>
                                    }
                                    {
                                        step == 5 &&
