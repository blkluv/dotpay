...
import { Approver, Safe } from '../../src/utils/types';
...
const Request: React.FC<Props> = ({ connectWallet, connected, address, errmsg }) => {
    ...
    const [safe, setSafe] = useState<Safe>({
        emissary: '64b683c15101ce3f213c1de4',
        owner: "",
        name: "",
        desc: "",
        asset: "",
                    ...
                    </div>
                    {
                        ...
                        <div className='flex-start'>
                            ...
                            </div>
                            {
                                ...
                                <Link href={safe.lump_amount.hash}>
                                ...
                                <div key={idx} className='w-900 flex-start mt-10'>
                                    ...
                                    </div>
                                    {
                                        ct['data'][midx]['approved'] ?
                                            <p className='font-14 inter-font ml-10 text-color-grey'>Signed on {ct['data'][midx]['at']}</p> :
